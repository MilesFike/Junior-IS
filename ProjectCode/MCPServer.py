...
Tell users that the EMNIST based model was used
Inform users that the model recognizes 0-9, A-Z, a-z characters
Trained model weights should be in EMNIST.pth in the same directory as this file
"""
...
def preprocess_image(image_path_or_bytes):
    ...
    try:
        ...
        listOfEdgePixels = []
        m3 = Image.open(temp_output)
        pixels = m3.load()# Gives attribute size
